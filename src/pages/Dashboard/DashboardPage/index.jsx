        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm dark:border dark:border-gray-700">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-gray-900 dark:text-gray-300 flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                    <button className="px-3 py-1 bg-blue-100 dark:bg-blue-600 text-blue-700 dark:text-white rounded text-sm">
                    Button
                    </button>
                    <button className="px-3 py-1 text-gray-600 dark:text-gray-400 rounded text-sm hover:bg-gray-100 dark:hover:bg-gray-800">
                    Button
                    </button>
                </div>
                </div>
