...
//       <nav
//         className={`fixed border-e-2 top-0 left-0 z-20 h-full pb-10 overflow-x-hidden overflow-y-auto transition origin-left transform bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 w-30 ${
...
//       {/* Botão Hambúrguer lateral (desktop) */}
//       <button
//         onClick={() => setCollapsed(!collapsed)}
//         className="hidden md:flex items-center justify-center absolute z-30 top-5 left-[58px] w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 shadow cursor-pointer hover:scale-105 transition"
//       >
//         <svg
//           xmlns="http://www.w3.org/2000/svg"
//           fill="none"
...
//         ${collapsed ? "w-20" : "w-60"}`}
//       >
//         <RouterLinks href="/" className="flex items-center px-4 py-5 justify-center">
